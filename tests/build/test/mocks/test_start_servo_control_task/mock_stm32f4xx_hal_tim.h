...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_Base_Start_DMA_CALLBACK)(TIM_HandleTypeDef* htim, uint32_t* pData, uint16_t Length, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_OC_Start_DMA_CALLBACK)(TIM_HandleTypeDef* htim, uint32_t Channel, uint32_t* pData, uint16_t Length, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_Encoder_Init_CALLBACK)(TIM_HandleTypeDef* htim, TIM_Encoder_InitTypeDef* sConfig, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_OC_ConfigChannel_CALLBACK)(TIM_HandleTypeDef* htim, TIM_OC_InitTypeDef* sConfig, uint32_t Channel, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_PWM_ConfigChannel_CALLBACK)(TIM_HandleTypeDef* htim, TIM_OC_InitTypeDef* sConfig, uint32_t Channel, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_IC_ConfigChannel_CALLBACK)(TIM_HandleTypeDef* htim, TIM_IC_InitTypeDef* sConfig, uint32_t Channel, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_ConfigOCrefClear_CALLBACK)(TIM_HandleTypeDef* htim, TIM_ClearInputConfigTypeDef* sClearInputConfig, uint32_t Channel, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_ConfigClockSource_CALLBACK)(TIM_HandleTypeDef* htim, TIM_ClockConfigTypeDef* sClockSourceConfig, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_SlaveConfigSynchro_CALLBACK)(TIM_HandleTypeDef* htim, TIM_SlaveConfigTypeDef* sSlaveConfig, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_SlaveConfigSynchro_IT_CALLBACK)(TIM_HandleTypeDef* htim, TIM_SlaveConfigTypeDef* sSlaveConfig, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_DMABurst_WriteStart_CALLBACK)(TIM_HandleTypeDef* htim, uint32_t BurstBaseAddress, uint32_t BurstRequestSrc, uint32_t* BurstBuffer, uint32_t BurstLength, int cmock_num_calls);
...
typedef HAL_StatusTypeDef (* CMOCK_HAL_TIM_DMABurst_MultiWriteStart_CALLBACK)(TIM_HandleTypeDef* htim, uint32_t BurstBaseAddress, uint32_t BurstRequestSrc, uint32_t* BurstBuffer, uint32_t BurstLength, uint32_t DataLength, int cmock_num_calls);
...
typedef HAL_TIM_StateTypeDef (* CMOCK_HAL_TIM_Base_GetState_CALLBACK)(TIM_HandleTypeDef* htim, int cmock_num_calls);
...
typedef HAL_TIM_StateTypeDef (* CMOCK_HAL_TIM_OC_GetState_CALLBACK)(TIM_HandleTypeDef* htim, int cmock_num_calls);
...
typedef HAL_TIM_StateTypeDef (* CMOCK_HAL_TIM_PWM_GetState_CALLBACK)(TIM_HandleTypeDef* htim, int cmock_num_calls);
...
typedef HAL_TIM_StateTypeDef (* CMOCK_HAL_TIM_IC_GetState_CALLBACK)(TIM_HandleTypeDef* htim, int cmock_num_calls);
...
typedef HAL_TIM_StateTypeDef (* CMOCK_HAL_TIM_OnePulse_GetState_CALLBACK)(TIM_HandleTypeDef* htim, int cmock_num_calls);
...
typedef HAL_TIM_StateTypeDef (* CMOCK_HAL_TIM_Encoder_GetState_CALLBACK)(TIM_HandleTypeDef* htim, int cmock_num_calls);
...
typedef HAL_TIM_ActiveChannel (* CMOCK_HAL_TIM_GetActiveChannel_CALLBACK)(TIM_HandleTypeDef* htim, int cmock_num_calls);
...
typedef HAL_TIM_ChannelStateTypeDef (* CMOCK_HAL_TIM_GetChannelState_CALLBACK)(TIM_HandleTypeDef* htim, uint32_t Channel, int cmock_num_calls);
...
typedef HAL_TIM_DMABurstStateTypeDef (* CMOCK_HAL_TIM_DMABurstState_CALLBACK)(TIM_HandleTypeDef* htim, int cmock_num_calls);
...
typedef void (* CMOCK_TIM_Base_SetConfig_CALLBACK)(TIM_TypeDef* TIMx, TIM_Base_InitTypeDef* Structure, int cmock_num_calls);
...
typedef void (* CMOCK_TIM_OC2_SetConfig_CALLBACK)(TIM_TypeDef* TIMx, TIM_OC_InitTypeDef* OC_Config, int cmock_num_calls);
