...
static struct mock_stm32f4xx_hal_adcInstance
{
  ...
  char HAL_ADC_UnRegisterCallback_IgnoreBool;
  HAL_StatusTypeDef HAL_ADC_UnRegisterCallback_FinalReturn;
  char HAL_ADC_UnRegisterCallback_CallbackBool;
  CMOCK_HAL_ADC_UnRegisterCallback_CALLBACK HAL_ADC_UnRegisterCallback_CallbackFunctionPointer;
  int HAL_ADC_UnRegisterCallback_CallbackCalls;
...
void mock_stm32f4xx_hal_adc_Verify(void)
{
  ...
  if (Mock.HAL_ADC_UnRegisterCallback_IgnoreBool)
    call_instance = CMOCK_GUTS_NONE;
  if (CMOCK_GUTS_NONE != call_instance)
  {
  ...
  if (Mock.HAL_ADC_UnRegisterCallback_CallbackFunctionPointer != NULL)
  {
    call_instance = CMOCK_GUTS_NONE;
    (void)call_instance;
  }
...
HAL_StatusTypeDef HAL_ADC_RegisterCallback(ADC_HandleTypeDef* hadc, HAL_ADC_CallbackIDTypeDef CallbackID, pADC_CallbackTypeDef pCallback)
{
  ...
  if (Mock.HAL_ADC_RegisterCallback_IgnoreBool)
  {
    ...
    memcpy((void*)(&Mock.HAL_ADC_RegisterCallback_FinalReturn), (void*)(&cmock_call_instance->ReturnVal),
         sizeof(HAL_StatusTypeDef[sizeof(cmock_call_instance->ReturnVal) == sizeof(HAL_StatusTypeDef) ? 1 : -1])); /* add HAL_StatusTypeDef to :treat_as_array if this causes an error */
    return cmock_call_instance->ReturnVal;
  }
  ...
  {
    HAL_StatusTypeDef cmock_cb_ret = Mock.HAL_ADC_RegisterCallback_CallbackFunctionPointer(hadc, CallbackID, pCallback, Mock.HAL_ADC_RegisterCallback_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return cmock_cb_ret;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  ...
  if (Mock.HAL_ADC_RegisterCallback_CallbackFunctionPointer != NULL)
  {
    cmock_call_instance->ReturnVal = Mock.HAL_ADC_RegisterCallback_CallbackFunctionPointer(hadc, CallbackID, pCallback, Mock.HAL_ADC_RegisterCallback_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
  return cmock_call_instance->ReturnVal;
}
...
HAL_StatusTypeDef HAL_ADC_UnRegisterCallback(ADC_HandleTypeDef* hadc, HAL_ADC_CallbackIDTypeDef CallbackID)
{
  ...
  if (Mock.HAL_ADC_UnRegisterCallback_IgnoreBool)
  {
    UNITY_CLR_DETAILS();
    if (cmock_call_instance == NULL)
      return Mock.HAL_ADC_UnRegisterCallback_FinalReturn;
    memcpy((void*)(&Mock.HAL_ADC_UnRegisterCallback_FinalReturn), (void*)(&cmock_call_instance->ReturnVal),
         sizeof(HAL_StatusTypeDef[sizeof(cmock_call_instance->ReturnVal) == sizeof(HAL_StatusTypeDef) ? 1 : -1])); /* add HAL_StatusTypeDef to :treat_as_array if this causes an error */
    return cmock_call_instance->ReturnVal;
  }
  if (!Mock.HAL_ADC_UnRegisterCallback_CallbackBool &&
      Mock.HAL_ADC_UnRegisterCallback_CallbackFunctionPointer != NULL)
  {
    HAL_StatusTypeDef cmock_cb_ret = Mock.HAL_ADC_UnRegisterCallback_CallbackFunctionPointer(hadc, CallbackID, Mock.HAL_ADC_UnRegisterCallback_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return cmock_cb_ret;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  ...
  if (Mock.HAL_ADC_UnRegisterCallback_CallbackFunctionPointer != NULL)
  {
    cmock_call_instance->ReturnVal = Mock.HAL_ADC_UnRegisterCallback_CallbackFunctionPointer(hadc, CallbackID, Mock.HAL_ADC_UnRegisterCallback_CallbackCalls++);
  }
  UNITY_CLR_DETAILS();
  return cmock_call_instance->ReturnVal;
}
...
void HAL_ADC_UnRegisterCallback_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, HAL_StatusTypeDef cmock_to_return)
{
  ...
  Mock.HAL_ADC_UnRegisterCallback_IgnoreBool = (char)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.HAL_ADC_UnRegisterCallback_IgnoreBool = (char)1;
}
...
{
  Mock.HAL_ADC_UnRegisterCallback_IgnoreBool = (char)0;
  Mock.HAL_ADC_UnRegisterCallback_CallbackBool = (char)1;
  Mock.HAL_ADC_UnRegisterCallback_CallbackFunctionPointer = Callback;
}

void HAL_ADC_UnRegisterCallback_Stub(CMOCK_HAL_ADC_UnRegisterCallback_CALLBACK Callback)
{
  Mock.HAL_ADC_UnRegisterCallback_IgnoreBool = (char)0;
  Mock.HAL_ADC_UnRegisterCallback_CallbackBool = (char)0;
  Mock.HAL_ADC_UnRegisterCallback_CallbackFunctionPointer = Callback;
}
